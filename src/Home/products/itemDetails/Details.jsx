...
const Details = () => {
  ...
  const { img, title, price, painter_name, uploaded, about } = data;
  return (
    <div className="flex lg:flex-row flex-col items-center justify-center my-32">
      ...
      <div className="border-2 md:w-[600px] w-[400px] md:rounded-r-2xl rounded-b-2xl p-6">
        ...
        <p className="mt-6 text-xl font-medium">Price : {price} $</p>
